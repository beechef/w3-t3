...
namespace EnhancedScrollerDemos.GridSimulation
{
    ...
    public class EnhancedController : MonoBehaviour, IEnhancedScrollerDelegate
    {
        /// <summary>
        ...
        {
            return 3;
            // return Mathf.CeilToInt(18 / (float)numberOfCellsPerRow);
        }
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            ItemRowRenderer cellView = scroller.GetCellView(cellViewPrefab) as ItemRowRenderer;
